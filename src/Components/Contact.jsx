        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          ...
          */}
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex flex-col items-center p-6 border rounded-xl shadow-md hover:shadow-lg transition duration-300 hover:text-blue-700"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex flex-col items-center p-6 border rounded-xl shadow-md hover:shadow-lg transition duration-300 hover:text-gray-800"
          >
