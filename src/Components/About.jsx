...
const About = () => {
  return (
    <section id="about" className="py-16 bg-zinc-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="rounded-lg overflow-hidden shadow-lg">
            <img 
              ...
              onError={(e) => {
                ...
                e.target.src = 'public/image/hero.jpg';
              }}
            />
          </div>
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6">
              I'm a web developer focused on creating beautiful and functional websites. 
              With experience in React, Tailwind CSS, and responsive design, I build 
              user-friendly interfaces that deliver great experiences.
            </p>
